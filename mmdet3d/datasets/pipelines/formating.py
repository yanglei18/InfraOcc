...
class Collect3D(object):
    ...
    def __init__(
        ...
        meta_keys=('filename', 'ori_shape', 'img_shape',
                   ...
                   'sequence_group_idx', 'curr_to_prev_lidar_rt', 'curr_to_prev_ego_rt', 'start_of_sequence', 'points_frame_splits', 'can_bus', 'scene_name',
                   'affine_aug', 'occ_gt_path', 'cam_names', 'timestamp',
                   'curr', 'adjacent', 'global_to_curr_lidar_rt',
                   'prev_lidar_to_global_rt', 'nuscenes_get_rt_matrix',
                   'ego_frame_reanchoring')):
        self.keys = keys
