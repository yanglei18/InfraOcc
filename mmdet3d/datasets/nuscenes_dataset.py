...
def _should_disable_valid_point_filter(metadata):
...
class NuScenesDataset(Custom3DDataset):
    ...
    def __init__(self,
        ...
        self.disable_valid_point_filter = False
        super().__init__(
            data_root=data_root,
            ann_file=ann_file,
            pipeline=pipeline,
    ...
    def get_cat_ids(self, idx):
        ...
        if self.disable_valid_point_filter:
    ...
    def load_annotations(self, ann_file):
        ...
        self.disable_valid_point_filter = _should_disable_valid_point_filter(
            self.metadata)
        return data_infos
